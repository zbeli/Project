...
struct predicate {
	...
	int flag;		    // -1 if there is a second rel_col_tuple(rel in the predicate)
	uint64_t value;		//  if there is no a second rel_col_tuple holds the int value of the filter
